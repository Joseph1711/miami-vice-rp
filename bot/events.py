...
STATUS_ACTIVITIES = [
    ...
    (discord.ActivityType.watching, "operaciones del MDFR & EMS 🚒🚑"),
    (discord.ActivityType.watching, "patrullas de FHP en la autopista 🛣️"),
    (discord.ActivityType.watching, "seguridad en Miami Beach (MBPD) 🏖️"),
    (discord.ActivityType.watching, "las subastas del Mercado Negro 💼"),
    (discord.ActivityType.watching, "el atardecer en South Beach 🌅"),
    (discord.ActivityType.watching, "casos de Florida Dept of Justice (FDOJ) ⚖️"),
